 ...
 * @return bool Success
 */
	public static function phone($check, $regex = null, $country = 'ind') {
		if (is_array($check)) {
			extract(static::_defaults($check));
		}
 ...
 * @return bool Success
 */
	public static function postal($check, $regex = null, $country = 'in') {
		if (is_array($check)) {
			extract(static::_defaults($check));
		}
 ...
 * @return bool Success
 */
	public static function url($check =null, $strict = false) {
                if (empty($check)) {
                    return true;
                }
        static::_populateIp();
