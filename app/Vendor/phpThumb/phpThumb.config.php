...
$PHPTHUMB_CONFIG['document_root'] = '/home/project-web/phpthumb/htdocs/';


// * Security configuration 
$PHPTHUMB_CONFIG['high_security_password']             = '61lt9b{=Xw-Y2A~8^FyX';     // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpThumb.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password 
...
//} 
$PHPTHUMB_CONFIG['cache_directory'] = '/home/project-web/phpthumb/htdocs/demo/cache/';
