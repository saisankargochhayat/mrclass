...
function loadHtml5Gallery(r) {
                ...
                if (a) {
                    ...
                    do
                        if ((u = a.interactions[g]) && !("dragend" !== e && u.cancelled)) k = n.properties(b, a, u), u.results = [], p(c || u[h] || a.droppable).each(function(c, d) {
                            ...
                            n.flatten(u.results), "dropinit" == e && (u.droppable = n.flatten(u.droppable)), "dragstart" == e && !u.cancelled && k.update(); while (++g < d);
                    b.type = f;
                    b.originalEvent = l;
    ...
    k.fn.addHTML5VideoControls = function(b, e) {
        ...
        var x = k(".html5boxTimeCurrent", s),
            A = k(".html5boxTimeTotal",
                s),
            w = k(".html5boxSeeker", s),
            F = k(".html5boxSeekerPlay", s),
            L = k(".html5boxSeekerBuffer", s),
        ...
        if (!p && (m.get(0).requestFullscreen || m.get(0).webkitRequestFullScreen || m.get(0).mozRequestFullScreen || m.get(0).webkitEnterFullScreen || m.get(0).msRequestFullscreen)) {
            var I = function(a) {
                ...
                var b = D.css("background-position") ? D.css("background-position").split(" ")[1] : D.css("background-position-y");
                D.css({
        ...
        if (m.get(0).volume === v / 2 + 0.1) {
            ...
            var v = k(".html5boxVolume", s),
                G = k(".html5boxVolumeButton", s),
                J = k(".html5boxVolumeBar", s),
                y = k(".html5boxVolumeBarBg", s),
                E = k(".html5boxVolumeBarActive", s);
            v.css({
                display: "block",
                position: "relative",
                "float": "right",
    ...
    b.fn.html5gallery = function(k) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                a.options.watermarkcode += "<div " + (a.options.fv ? "" : "class='html5gallery-watermark-" + a.id + "' ") + "style='" + (a.options.fv ? "display:none;visibility:hidden;position:absolute;top:10px;left:10px;width:170px;height:18px;line-height:18px;text-align:center;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;background-color:#fff;color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;" :
            ...
            initData: function(a) {
                ...
                if (this.options.src && 0 < this.options.src.length) {
                        ...
                        success: function(d) {
                            b(d).find("slide").each(function(a) {
                                ...
                                c.elemArray.push([b(this).find("id").length ?
                                    ...
                                    b(this).find("hd").text(), b(this).find("hdogg").text(), b(this).find("hdwebm").text(), b(this).find("duration").text(), b(this).find("lightboxwidth").text(), b(this).find("lightboxheight").text()
                                ])
                            });
                            c.readTags();
                            a(c)
                    ...
                    for (var d = 0; d < b.length; d++) {
                        ...
                        c.elemArray.push([d, b[d].thumbnail, b[d].file, b[d].fileogg, b[d].filewebm, b[d].link, b[d].linktarget,
                            b[d].title, b[d].description, e, b[d].width && !isNaN(parseInt(b[d].width)) ? parseInt(b[d].width) : c.options.width, b[d].height && !isNaN(parseInt(b[d].height)) ? parseInt(b[d].height) : c.options.height, b[d].poster, b[d].hd, b[d].hdogg, b[d].hdwebm, b[d].duration, b[d].lightboxwidth, b[d].lightboxheight
                        ])
                    }
                    c.readTags();
                    a(c)
                    ...
                    "start-index": this.options.youtubechannel["start-index"] ?
                        this.options.youtubechannel["start-index"] : 1,
                    "max-results": this.options.youtubechannel["max-results"] ? this.options.youtubechannel["max-results"] : 10
                }, this.options.youtubechannel.author ? d.author = this.options.youtubechannel.author : this.options.youtubechannel.q && (d.q = this.options.youtubechannel.q), d = "https://gdata.youtube.com/feeds/api/videos?" + b.param(d), c = this, b.getJSON(d, function(b) {
                    if (b && b.feed && b.feed.entry)
                        for (var d = 1; d < b.feed.entry.length; d++) c.elemArray.push([d, ("https:" == document.location.protocol ?
                            "https:" : "http:") + "//img.youtube.com/vi/" + b.feed.entry[d].media$group.yt$videoid.$t + "/0.jpg", b.feed.entry[d].media$group.media$player.url, null, null, null, null, b.feed.entry[d].media$group.media$title.$t, b.feed.entry[d].media$group.media$description.$t, 9, 640, 480, ("https:" == document.location.protocol ? "https:" : "http:") + "//img.youtube.com/vi/" + b.feed.entry[d].media$group.yt$videoid.$t + "/0.jpg", null, null, null, null]);
                    c.readTags();
                    a(c)
                })) : this.options.youtubeapikey && this.options.youtubeplaylistid ? (c = this,
            ...
            readTags: function() {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    ...
                    var h = a.options.width,
                        ...
                        x = null,
                        C = null;
                    b(this).parent().is("a") && (c = b(this).parent().attr("href"), k = b(this).parent().data("ogg"), n = b(this).parent().data("webm"), p = b(this).parent().data("link"), r = b(this).parent().data("linktarget"), q = b(this).parent().data("poster"),
                        isNaN(b(this).parent().data("width")) || (h = b(this).parent().data("width")), isNaN(b(this).parent().data("height")) || (j = b(this).parent().data("height")), t = b(this).parent().data("hd"), m = b(this).parent().data("hdogg"), v = b(this).parent().data("hdwebm"), z = b(this).parent().data("lightboxwidth"), B = b(this).parent().data("lightboxheight"), s = b(this).parent().data("youtubeapikey"), x = b(this).parent().data("youtubeplaylistid"), C = b(this).parent().data("youtubeplaylistmaxresults"));
                    var A = b(this).parent().data("mediatype") ?
                        b(this).parent().data("mediatype") : a.checkType(c);
                    a.elemArray.push([a.elemArray.length, d, c, k, n, p, r, e, f, A, h, j, q, t, m, v, g, z, B, s, x, C])
                })
            },
            ...
            createStyleVertical: function() {
                this.options.thumbimagewidth = this.options.thumbshowtitle ? this.options.thumbheight - 2 * this.options.thumbimageborder -

                    4 : this.options.thumbwidth - 2 * this.options.thumbimageborder - 4;
                ...
                var c = " .html5gallery-container-" + this.id + " { display:block; position:absolute; left:0px; top:0px; width:" +
                ...
                var c = c + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" +
                    ...
                    c = c + (" .html5gallery-viral-" + this.id + " {display:block; overflow:hidden; position:absolute; text-align:left; top:" + d + "px; left:0px; width:" + this.options.boxWidth +
                    ...
                    c = c + (" .html5gallery-timer-" + this.id + " {display:block; position:absolute; top:" +
                ...
                this.options.isIE7 || this.options.isIE6 ? (c += " .html5gallery-loading-" + this.id + " {display:none; }", c += " .html5gallery-loading-center-" + this.id + " {display:none; }") :
                ...
                this.options.showcarousel ? (c += " .html5gallery-car-" +
                    ...
                    "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ", a = this.options.thumbwidth - 3 * this.options.thumbmargin, this.options.thumbshowimage ? (a -= this.options.thumbimagewidth + 2 * this.options.thumbimageborder, d = this.options.thumbshowtitle ? this.options.thumbmargin : this.options.thumbwidth / 2 - (this.options.thumbimagewidth + 2 * this.options.thumbimageborder) / 2, e = Math.round((this.options.thumbheight - 2) / 2 - (this.options.thumbimageheight + 2 * this.options.thumbimageborder) / 2), c += " .html5gallery-tn-img-" +
                        ...
                        if (!(this.options.thumbShowNum >= this.elemArray.length)) {
                            ...
                            var d = a / (this.elemArray.length * (this.options.thumbheight + this.options.thumbgap) - this.options.thumbMaskHeight),
                        ...
                        a.pageY > b(".html5gallery-car-slider-" + this.id, this.$gallery).offset().top ? (a = -1 * parseInt(d.css("margin-top")) + this.options.thumbShowNum * (this.options.thumbheight + this.options.thumbgap), a >= this.options.thumbTotalHeight -
                            this.options.thumbMaskHeight && (a = this.options.thumbTotalHeight - this.options.thumbMaskHeight)) : (a = -1 * parseInt(d.css("margin-top")) - this.options.thumbShowNum * (this.options.thumbheight + this.options.thumbgap), 0 > a && (a = 0));
                        d.stop(!0).animate({
                            marginTop: -a
                        }, 500);
                        this.updateCarouseButtons(-a);
                        ...
                        c < this.options.carouselSliderMin && (c = this.options.carouselSliderMin);
                        ...
                        if (0 != parseInt(a.css("margin-top"))) {
                            var d = -1 * parseInt(a.css("margin-top")) -
                        ...
                        if (parseInt(a.css("margin-top")) != -(this.options.thumbTotalHeight - this.options.thumbMaskHeight)) {
                            ...
                            d >= this.options.thumbTotalHeight -
                                this.options.thumbMaskHeight && (d = this.options.thumbTotalHeight - this.options.thumbMaskHeight);
                            a.animate({
                                marginTop: -d
                            }, 500, this.options.carouseleasing);
                            this.updateCarouseButtons(-d)
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    a += " .html5gallery-toolbox-bg-" + this.id + " {display:block; left:0px; top:0px; width:100%; height:100%; position:absolute; filter:alpha(opacity=60); opacity:0.6; background-color:#222222; }", a += " .html5gallery-toolbox-buttons-" + this.id + " {display:block; margin:0px auto; height:100%;}", a += " .html5gallery-play-" + this.id + " { position:relative; float:left; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:32px; height:32px; margin-left:2px; margin-right:2px; margin-top:" +
                        ...
                        a += " .html5gallery-play-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" :
                            "none") + "; cursor:pointer; top:" + c + "px; left:" + f + "px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_play.png') no-repeat top left;} ";
                        a += " .html5gallery-pause-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + c + "px; left:" + f + "px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_pause.png') no-repeat top left;} ";
                        ...
                        a += " .html5gallery-lightbox-" +
                            this.id + " {position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + c + "px; left:" + e + "px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_lightbox.png') no-repeat top left;} "
                    }
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (this.options.showcarousel && (this.options.carouselHeight = this.options.thumbheight + 2 * this.options.thumbmargin, this.options.carouselmultirows)) {
                        ...
                        } else this.options.carouselcolumn = Math.floor(this.options.width / (this.options.thumbwidth + this.options.thumbgap)), 1 > this.options.carouselcolumn && (this.options.carouselcolumn = 1);
                    ...
                    this.options.boxHeight = this.options.height + this.options.headerHeight;
                    this.options.slideshadow && (this.options.boxWidth += 8);
                    this.options.showcarousel && (this.options.carouselWidth = this.options.width, this.options.carouselLeft = this.options.padding,
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        if (this.isFullscreen) {
                            var a = this.elemArray[this.curElem][17] ?
                                Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth,
                        ...
                        width: a + "px",
                        height: e + "px"
                    }), b("#html5gallery-elem-video-" + this.id).attr("width", a), b("#html5gallery-elem-video-" + this.id).attr("height", e), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", a), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", e), b("#html5gallery-elem-video-" +
                        this.id).find("iframe").attr("width", a), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", e);
                    f = a = 0;
                    ...
                    this.options.showcarousel && (b(".html5gallery-car-" + this.id).css({
                        ...
                        }), this.options.carouselNavButton = !1, Math.floor((this.options.width - a - 4) / (this.options.thumbwidth + this.options.thumbgap)) <
                        this.elemArray.length && (this.options.carouselNavButton = !0), f = this.options.carouselNavButton ? 2 * this.options.carouselarrowwidth + 8 : 0, b(".html5gallery-car-left-" + this.id).css({
                            display: this.options.carouselNavButton ? "block" : "none"
                        }), b(".html5gallery-car-right-" + this.id).css({
                            display: this.options.carouselNavButton ? "block" : "none"
                        }), this.options.thumbShowNum = Math.floor((this.options.width - a - 4 - f) / (this.options.thumbwidth + this.options.thumbgap)), this.options.thumbMaskWidth = this.options.thumbShowNum * this.options.thumbwidth +
                        this.options.thumbShowNum * this.options.thumbgap, this.options.thumbTotalWidth = this.elemArray.length * this.options.thumbwidth + (this.elemArray.length - 1) * this.options.thumbgap, f = 0, this.options.carouselmultirows ? "samecolumn" == this.options.thumbresponsive ? (b(".html5gallery-thumbs-" + this.id).css({
                            ...
                            "margin-left": f + "px",
                            width: this.options.width + "px"
                        })) : (this.options.thumbMaskWidth > this.options.thumbTotalWidth && (f = this.options.thumbMaskWidth / 2 - this.options.thumbTotalWidth /
                            2 - this.options.thumbgap / 2), b(".html5gallery-thumbs-" + this.id).css({
                            "margin-left": f + "px",
            ...
            createStyleDefault: function() {
                ...
                this.options.showcarousel ? (this.options.carouselWidth = this.options.width, this.options.carouselHeight = this.options.thumbheight + 2 * this.options.thumbmargin, this.options.carouselLeft = this.options.padding, this.options.carouselTop = this.options.padding + this.options.boxHeight + this.options.carouselmargin, this.options.carouselmultirows && ("samecolumn" == this.options.thumbresponsive ? (this.options.carouselcolumn = this.options.thumbcolumns, this.options.thumbcolumnsresponsive && (a = this.options.isMobile ?
                    ...
                    (this.options.thumbheight + this.options.thumbrowgap))) : (this.options.carouselWidth = 0, this.options.carouselHeight = 0, this.options.carouselLeft = 0, this.options.carouselTop = 0, this.options.carouselmargin = 0);
                ...
                var d = 0,
                    c = 0;
                this.options.elemTop = 0;
                "top" == this.options.headerpos ? (c = 0, d = this.options.socialheight, this.options.elemTop = this.options.headerHeight) : "bottom" == this.options.headerpos && (this.options.elemTop = 0, d = this.options.titleoverlay ? this.options.height -
                    this.options.titleheight : this.options.height, c = this.options.titleoverlay ? this.options.height : this.options.height + this.options.titleheight);
            ...
            showImage: function() {
                ...
                b(c).load(function() {
                    ...
                    if (d.isFullscreen) {
                        ...
                        c = d.elemArray[d.curElem][18] ? Math.min(d.elemArray[d.curElem][18], d.fullscreenHeight) :
                            d.fullscreenHeight;
                ...
                b(c).error(function() {
                    $preloading.remove();
                    d.isFullscreen && d.adjustFullscreen(d.options.width,
                        d.options.height);
            ...
            showPoster: function() {
                ...
                b(h).load(function() {
                    ...
                    g = b("<div class='html5gallery-elem-img-" + c.id + "' style='display:block; position:absolute; overflow:hidden; width:" + g + "px; height:" + k + "px; left:0px; margin-left:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + c.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + p + "px; top:" + r + "px; max-width:none; max-height:none; width:" +
                        n + "px; height:" + h + "px;' src='" + c.elemArray[c.curElem][12] + "' />" + c.options.watermarkcode + "</div>");
            ...
            showEmbedVideo: function(a) {
                ...
                b(".html5gallery-elem-" + this.id, d).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div id='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" +
                    (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + e + "px;height:" + c + "px;'></div>" + this.options.watermarkcode);
        ...
        this.each(function() {
            ...
            l = f.length;
            for (d = 0; 5 > d; d++) f = f.slice(0, l - 9 + d) + f.slice(l - 8 +
                d); - 1 != this.options.htmlfolder.indexOf(f) && (this.options.fv = !1);
            l = b(window).width();
            if (this.options.screenquery)
                for (d in this.options.screenquery) l <= this.options.screenquery[d].screenwidth && (this.options.screenquery[d].gallerywidth && (this.options.width = this.options.screenquery[d].gallerywidth), this.options.screenquery[d].galleryheight && (this.options.height = this.options.screenquery[d].galleryheight), this.options.screenquery[d].thumbwidth && (this.options.thumbwidth = this.options.screenquery[d].thumbwidth),
                    this.options.screenquery[d].thumbheight && (this.options.thumbheight = this.options.screenquery[d].thumbheight));
