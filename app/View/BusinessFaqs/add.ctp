...
<div class="content-full business-timing-details">
    ...
    <div class="content-right fl">
        <div class="heading">
            <span class="edit-business"></span> Add Business Faqs
        ...
        <div class="cb"></div>
		<?php echo $this->Form->create('BusinessFaq', array('method' => 'post','autocomplete' => 'off'));?>
        <div class="bg-trns-white">
			<div class="sub-heading">Add Faq</div>
            <div class="con-w-40" style="width:100%;">
				...
				<div class="wd-full fl">
                    <button class="cmn_btn_n pad_big" type="button" onclick="validate_user_add_business_faqs();">SUBMIT</button>
                </div>
