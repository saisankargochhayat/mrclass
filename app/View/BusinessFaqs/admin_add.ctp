...
<section class="content-header">
    <h1><?php echo __('Business Faqs'); ?><small></small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#FaqAdd" data-toggle="tab">New Business Faq</a></li>
                    <!--<li><a href="#userAdd" data-toggle="tab">Settings</a></li>-->
                </ul>
                <div class="tab-content">
                    <div class="active tab-pane" id="BusinessFaqAdd">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-1 col-sm-11">
                                <button type="button" class="btn btn-success" onclick="validate_business_faqs();"><?php echo __('Submit'); ?></button>
                                &nbsp;or&nbsp;
