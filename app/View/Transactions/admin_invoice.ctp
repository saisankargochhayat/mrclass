...
if (!empty($transactions['Transaction']['discount'])) {
    if ($transactions['Transaction']['sub_total'] < $transactions['Transaction']['discount']) {
        ...
        $desc = "Discount price is the amount remained from the last subscription, if you want to switch to another package before the current subscription ends.";
    }
} else {
    $label_text = "Discount";
    $total_text = "Total Price";
...
<section class="content-header">
    <h1>
        Invoice
        <small>#<?php echo $invoice_number; ?></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo $this->Html->url($adminpanel_dashboard_link); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo $this->Html->url(array('controller' => 'subscriptions', 'action' => 'index', 'admin' => 1)); ?>"></i> Subscriptions</a></li>
        <li>Invoice</li>
    </ol>
</section>
...
<section class="invoice">
    ...
    <div class="row invoice-info">
        ...
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
            <b>Invoice #:</b> <?php echo $transactions['Transaction']['invoice_number']; ?><br/>
    ...
    <div class="row">
        <div class="col-xs-12 table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td><?php echo $transactions['Subscription']['name']; ?></td>
    ...
    <div class="row no-print">
        <div class="col-xs-12">
            <a href="<?php echo $this->Html->url(array('controller' => 'transactions', 'action' => 'print_invoice', 'admin' => 1, $transactions['Transaction']['id'], 'print')); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
            <a href="<?php echo $this->Html->url(array('controller' => 'transactions', 'action' => 'generate_pdf', 'admin' => 1, $transactions['Transaction']['id'], $invoice_number)); ?>" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</a>
        </div>
    </div>
</section>
<!-- /.content -->
