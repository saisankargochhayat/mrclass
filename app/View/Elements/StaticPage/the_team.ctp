...
<div class="white-trp-bg our-team">
    ...
    <div id="profile_1" class="profile">
        ...
        <p style="text-align: justify;">Sujeet Kumar currently serves as the OSD-cum-Special Secretary of the Odisha State Planning Board, a very senior policy-planning position, within the Government. He is also a mentor at ‘LexMantra,  (<a href="http://www.lexmantra.net" target="_blank">www.lexmantra.net</a>), a boutique Consulting firm, providing a range of legal & business advisory solutions for businesses of all sizes, particularly for start-ups. Sujeet is also the Founder & Adviser of Kalinga Kusum (<a href="http://www.kalingakusum.org" target="_blank">www.kalingakusum.org</a>), a social enterprise that addresses challenges tied to education, entrepreneurship and legal empowerment in rural communities in India.</br></br>Sujeet studied for the mid-career Master in Public Administration (MPA) at the prestigious Harvard University. He also has the distinction of receiving the inaugural Skoll Scholarship for Social Entrepreneurship, in-order to study for his MBA at University of Oxford. Sujeet also holds Bachelor’s degrees in Engineering and Law from India.
</br></br>An entrepreneur, investor and an avid start-up enthusiast, Sujeet currently advises & mentors a number of start-up entrepreneurs, small and growing businesses, social business enterprises, non-profit organizations, impact investors and donor organizations- both Indian and foreign - on a range of business strategy, legal, regulatory and corporate governance issues in India. Sujeet loves the outdoors, and exploring different places and learning about their culture and history.
</p>
