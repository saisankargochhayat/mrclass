<?php
echo $this->Html->script(array('moment.min', 'bootstrap-datepicker.min.js'), array('inline' => false));
echo $this->Html->css(array('bootstrap-datepicker.min.css'), array('block' => 'bootstrap_datatable_css'));
...
<style type="text/css">
    ...
    #limit_info_div{display: none;}
    #dimension_info_div{display: none;}
    .image_preview{display: none;}
</style>
<section class="content-header">
    <h1><?php echo __('Add Advertisement'); ?></h1>
    <ol class="breadcrumb">
        ...
        <li><?php echo __('Add Advertisement'); ?></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#advertisementAdd" data-toggle="tab"><?php echo __('Add Advertisement'); ?></a></li>
                </ul>
                <div class="tab-content">
                    <div class="active tab-pane" id="advertisementAdd">
                        <?php echo $this->Form->create('Advertisement', array('action' => 'add', 'class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
                        <div class="box box-default">
                            ...
                            <div class="box-body" id="banner_desc">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo $this->Form->input('name', array('label' => false, 'div' => false, 'placeholder' => 'Ad Name', 'class' => 'form-control')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo $this->Form->input('description', array('type' => 'textarea', 'label' => false, 'div' => false, 'placeholder' => 'Ad Description', 'class' => 'form-control')); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="dropzone"> 
                                    ...
                                    <div class="col-sm-10">
                                        <div class="btn btn-default btn-file col-xs-3">
                                            <i class="fa fa-paperclip"></i> Select Ad Image
                                ...
                                <div class="form-group margin-bottom image_preview">
                                    <div class="col-sm-2">
                                    </div>
                                    <div class="col-sm-10">
                                        <span class="mailbox-attachment-icon has-img"><img class="img-responsive" src="" alt="banner_img"></span>
                                        <div class="mailbox-attachment-info">
                                            <a href="#" class="mailbox-attachment-name"><i class="fa fa-camera"></i> photo2.png</a>
                                            <span class="mailbox-attachment-size"><span id="image_size"></span>
                                                <a href="#" class="btn btn-default btn-xs pull-right image_delete" data-id=""><i class="fa  fa-trash"></i></a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="col-sm-10" style="padding-top:8px;">
                                        <div class="col-xs-2">
                                            <label for="budget_daily">
                                                <input name="data[Advertisement][budget_type]" id="budget_daily" value="Daily" type="radio" checked/>&nbsp;&nbsp;Daily Budget
                                            </label>
                                        </div>
                                        <div class="col-xs-2">
                                            <label for="budget_total">
                                                <input name="data[Advertisement][budget_type]" id="budget_total" value="Total" type="radio" />&nbsp;&nbsp;Total Budget
                                            </label> 
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="form-group" id="limit_info_div">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <span class="label label-primary" id="package_lim">No. Of Views : 0</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10" style="padding-top:8px;">
                                        <div class="col-xs-5">
                                            <label for="run_daily">
                                                <input name="data[Advertisement][schedule_type]" id="run_daily" value="Immediate" class="range_radio" type="radio" checked/>&nbsp;&nbsp;Run ad set continuously starting today
                                            </label>
                                        </div>
                                        <div class="col-xs-5">
                                            <label for="run_specific">
                                                <input name="data[Advertisement][schedule_type]" id="run_specific" value="Specific" class="range_radio" type="radio" />&nbsp;&nbsp;Set a start date
                                            </label> 
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="form-group" id="range_div">
                                    <label for="AdvertisementCostPerView" class="col-sm-2 control-label"><?php echo __('Start Date'); ?>*</label>
                                    <div class="col-sm-10">
                                        <?php echo $this->Form->input('campaign_range', array('label' => false, 'div' => false, 'placeholder' => 'Select Start Date', 'class' => 'form-control')); ?>
                                        <div class="error" id="AdvertisementDateRange_error"></div>
                                    </div>
                                </div>
                                <input type="hidden" name="data[Advertisement][campaign_start]" id="campaign_start" value="">
                                <input type="hidden" name="data[Advertisement][campaign_end]" id="campaign_end" value="">
                            </div>
                            <div class="box-footer"></div>
                        </div>
                        <input type="hidden" name="data[Advertisement][image]" id="banner_id" value=""/>
                        <div class="form-group">
...
<script>
    ...
    var banner_url = '<?php echo $this->Html->url(array("controller" => "advertisements", "action" => "add", "admin" => 1)); ?>';
    jQuery(document).ready(function($) {
        var date_range_picker_opts = {autoUpdateInput: false,locale: {cancelLabel: 'Clear'}};
        $('#AdvertisementCampaignRange').datepicker(date_range_picker_opts);
        /*$('#AdvertisementCampaignRange').on('apply.datepicker', function(ev, picker) {
        ...
        $(".range_radio").on('change', function() {
            if (_.trim($(this).val()) == "Immediate") {
                $("#range_div").slideUp();
                //   $("#range_div").hide();
                $('#AdvertisementCampaignRange').val('');
            } else {
                $("#range_div").slideDown();
                // $("#range_div").show();
            }
        ...
        $('#AdvertisementPageId').on('change', function() {
            ...
            if (page_id) {
                ...
                if (page_dim_info) {
                    ...
                    var dim_info_res = explode('*', trim(typeof dim_info_spl[1] == 'undefined' ? dim_info_spl[0] : dim_info_spl[1]));
        ...
        $('#AdvertisementAddForm').fileupload({
            url: banner_url,
            type: 'post',
            dataType: 'json',
            add: function(e, data) {
            ...
            progress: function(e, data) {
                ...
                if (resp_obj.status == "success") {
                    ...
                    //var fieldHTML = '<input type="hidden" name="data[Advertisement][image]" id="' + resp_obj.tmp_name + '" value="' + resp_obj.tmp_name + '@' + resp_obj.file_name + '"/>';
                    //$(fieldHTML).appendTo($('#AdvertisementAddForm'));
