...
<?php echo $this->Form->create('PackageDiscount'); ?>
	<fieldset>
		<legend><?php echo __('Edit Package Discount'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PackageDiscount.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('PackageDiscount.id')))); ?></li>
