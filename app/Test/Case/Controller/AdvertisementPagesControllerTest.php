<?php
App::uses('AdvertisementPagesController', 'Controller');

/**
 * AdvertisementPagesController Test Case
 */
class AdvertisementPagesControllerTest extends ControllerTestCase {
